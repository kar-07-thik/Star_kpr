...
import { getStudentNotifications, markNotificationRead, markAllNotificationsRead, deleteStudentNotification, deleteStudentNotifications } from '../utils/api.js'
...
export default function StudentNotificationsPage({ onUnreadChange }) {
  ...
  async function handleRemoveSelected() {
    ...
    setRemoving(true)
    try {
      await deleteStudentNotifications([...selected])
